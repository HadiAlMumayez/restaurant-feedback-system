 ...
 * Login Page
 * 
 * Admin authentication page with email/password and Google login.
 */
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full py-3 gradient-brand text-white font-semibold rounded-xl
          ...
          <button
            ...
            disabled={isSubmitting}
            className="w-full py-3 bg-white border-2 border-gray-200 text-charcoal font-medium 
